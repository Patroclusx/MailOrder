 ...
 * 
 */
@WebServiceClient(name = "OrderServiceService", targetNamespace = "http://webservices.mailorder.net/", wsdlLocation = "http://localhost:8080/Mailorder/services/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICESERVICE_QNAME = new QName("http://webservices.mailorder.net/", "OrderServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Mailorder/services/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://webservices.mailorder.net/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.mailorder.net/", "OrderServicePort"), OrderService.class, features);
    }
